    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-cream-50 px-4">
      <div className="w-full max-w-sm flex-1 flex flex-col justify-center">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-rust-500 rounded-xl flex items-center justify-center mx-auto mb-3">
        ...
        <form
          ...
          className="bg-white rounded-xl shadow-sm border border-cream-200 p-6 space-y-4"
        >
          {announcement && (
          ...
          <button
            ...
            className="w-full py-2.5 bg-rust-500 text-white rounded-lg text-sm font-medium
                       hover:bg-rust-600 disabled:opacity-50 transition-colors
