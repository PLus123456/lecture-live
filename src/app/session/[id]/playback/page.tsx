...
export default function PlaybackPage() {
  ...
  const startFinalizeBgRefresh = useCallback(
    (options: { optimistic: boolean }) => {
      ...
      const needsReport = () => reportDataRef.current === null;
      const needsTitle = () => {
              ...
              {activeTab === 'report' && (
                <div className="space-y-4">
                  {reportLoading ? (
                    ...
                    <div className="text-center text-charcoal-400 text-sm py-8">
                      {reportPendingBg ? (
                        <div data-testid="report-generating-bg">
