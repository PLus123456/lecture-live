...
const FONT_SIZE_MAP = {
  small: { text: 'text-xs', translation: 'text-sm', timestamp: 'text-[10px]', summary: 'text-xs', keypoint: 'text-[11px]' },
  medium: { text: 'text-sm', translation: 'text-base', timestamp: 'text-[11px]', summary: 'text-sm', keypoint: 'text-xs' },
  large: { text: 'text-base', translation: 'text-lg', timestamp: 'text-xs', summary: 'text-base', keypoint: 'text-sm' },
} as const;
